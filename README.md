...
Black backgrounds, purple borders
...
-Per-app rules (Spotify, Telegram, battery warnings) (feel free to add smth by yourself)
...
```sh
git clone https://github.com/NeyoKawai/dunst-OneShotTheme
